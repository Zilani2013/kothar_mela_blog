...
<!-- content -->
<div class="col-md-8" id="postContent" style="background: #bcbb8b;"><br>
	<div style=" position: relative; left: -50px;">
		<form action="<?php echo $baseurl; ?>main_control/submit_post_data" method="POST" class="form-horizontal" enctype="multipart/form-data">
		  <!-- category -->
			...
			<!-- post image -->
		    	...
		    	<div class="col-sm-9">
		    		<span style="color: #c6321b; font-weight: bold; font-size: 12px;"></span>
		      		...
		      		<span style="font-weight: bold;">Only jpg,png,gif,jpeg Files are allowed and size must be less than 1MB</span>
		    	</div>
		  	</div>
			...
			<!-- post content -->
    	  	<div class="form-group">
		    	...
		    	<div class="col-sm-9">
		      		<textarea name="post_content" id="post" class="form-control" cols="30" rows="25"></textarea>
		      		<span style="color: red;"><?php echo form_error('post_content'); ?></span>
		    	</div>
		  	</div>
