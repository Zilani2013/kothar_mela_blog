...
<!-- main content -->
<div class="col-sm-8" id="postContent" style="padding: 40px; position: relative;">
    ...
    <?php else : ?>
        <div>
            <img style="position: relative; left: 80px;" src="<?php echo base_url().$singledata->post_image; ?>" height="360px;" width="640px;">
        </div>
        <br><br>
    <?php endif; ?>
