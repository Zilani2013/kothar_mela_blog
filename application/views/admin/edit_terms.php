...
<div class="col-md-6" id="postContent2" style="background: #bcbb8b; position: relative; top: 50px;">
	<div>
		<form action="<?php echo base_url(); ?>admin_control/update_terms" method="POST" class="form-horizontal" enctype="multipart/form-data">
			<!-- post content -->
    	  	<div class="form-group">
		    	<label for="post" class="col-sm-3 control-label">About Blog</label>
		    	<div class="col-sm-9">
		      		<textarea name="terms" id="post" class="form-control" cols="30" rows="23"><?php echo $terms; ?></textarea>
		    	</div>
		  	</div>	
