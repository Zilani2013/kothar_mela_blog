...
<?php foreach($post_data as $singlepost) : ?>
	<div>
		<form action="<?php echo base_url(); ?>admin_control/update_post" method="POST" class="form-horizontal" enctype="multipart/form-data">
	 	 	<!-- category -->
		  	<div class="form-group">
		    	<label for="categories" class="col-sm-3 control-label">পোস্ট ক্যাটাগরি <span style="color: red; font-weight: bold;">*</span></label>
		  	...
		  	<!-- post title -->
		  	<div class="form-group">
		    	<label for="title" class="col-sm-3 control-label">পোস্ট টাইটেল <span style="color: red; font-weight: bold;">*</span></label>
		    	<div class="col-sm-9">
			...
			<!-- post image -->
  		  	<div class="form-group">
		    	<label for="image" class="col-sm-3 control-label">পোস্ট ইমেজ</label>
		    	<div class="col-sm-9">
			...
			<!-- post content -->
    	  	<div class="form-group">
		    	<label for="post" class="col-sm-3 control-label">আপনার পোস্ট <span style="color: red; font-weight: bold;">*</span></label>
		    	<div class="col-sm-9">
		      		<textarea name="post_content" id="post" class="form-control" cols="30" rows="14"><?php echo $singlepost->post_content; ?></textarea>
		    	</div>
		  	</div>
